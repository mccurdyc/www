...
then as an organization, we are doing makes us happy internally, but also what
is best for our customers. Even if we are delivering new features all of the time,
if our site is slow or unreliable, users will overlook features or be ultimately
be able to use the features if the site is down. But as engineers, we also have
...
who I work with who used to be an engineer and knows when they cannot push for
features until something is fixed. From the other side, more recently with knowledge
...
solution is without experiencing the problem and its nuances.

The ultimate goal is to do what is best for the company and its users.
...
smaller than six to eight engineers and managers are getting too deep into technical
...
parts of a system, it leads to engineers "tuning out" during _regular_ team
ceremonies when others are talking about their part of the system. It can be helpful
...
in order to be effective owners of part of a system. If these micro-teams don't
...
people problems, often a solution can be putting these people closer together
...
This is basically the idea of collecting metrics to establish a baseline, then
making some change and tweaking until it is "successful" at which point you
document why it was successful. Next, getting a _few_ people from other teams to
confirm that the approach is effective given the same problem. Finally, _sharing_
...
and similar to Will, I have experienced wider adoption than me lobbying for the change.
...
did also play a part as in the poor experience my manager was not able to keep the
...
Working the policy instead of the exceptions, means don't make one-off exceptions.
